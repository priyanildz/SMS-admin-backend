...
// Define storage for question papers
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    // NOTE: 'uploads' directory must exist in your project root
    cb(null, 'uploads/'); 
  },
...
// MODIFIED ROUTE: Add Multer middleware for file upload (single file named 'questionPaperFile')
router.post("/add-set", upload.single('questionPaperFile'), questionPaperController.createSets);
