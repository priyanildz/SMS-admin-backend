...
        if (search) {
            const searchRegex = new RegExp(search, "i"); // 'i' for case-insensitive
            // Complex search logic retained for consistency
            query.$or = [
                { "firstname": searchRegex },
                { "lastname": searchRegex },
                { "studentid": searchRegex },
...
// 🆕 NEW ENDPOINT: Get all students admitted in the current academic year (Active + Inactive)
...
        const students = await User.find({
            "admission.admissiondate": {
                $gte: new Date("2024-01-01"), // Fixed date is used here
            },
            status: {
                $ne: false // Only new, non-LC students
            }
